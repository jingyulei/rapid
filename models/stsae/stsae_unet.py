...
class STSE_Unet(nn.Module):
    ...
    joints_to_consider = {'a':75, 'b': 12, 'c': 10, 'd': 8}
    
    def __init__(self, c_in:int, embedding_dim:int=256, latent_dim:int=64, n_frames:int=12, n_joints:int=75,
        ...
        Args:
            ...
            n_joints (int, optional): number of joints of the input pose sequence. Defaults to 75.
...
class STSAE_Unet(STSE_Unet):
    ...
    def __init__(self, c_in:int, embedding_dim:int=256, n_frames:int=12, n_joints:int=75,
